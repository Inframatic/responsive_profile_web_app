...
function BusinessCtrl($scope) {
  ...
  $scope.hovering = false;
    ...
    $scope.companies = [
      ...
      {name:'Mcdonalds',industry:'Porn Industry', "paidvolunteer": 'Volunteer', location: "New York", firstinterview: "yes", company_size: 100000, "keyworddescription": "After the Hamburglar was fired from McDonalds for burger theft, he invested 2.5 million dollars into the porn industry and now it has become the booming porn company you see today. Crazy yeah. I knew a guy who got that rich. His name was Jerry. Jerry was a dick though. Just goes to show you that rich people dont have to be good people."},
      ...
      {name:'Jesus Christ',industry:'Web Development', "paidvolunteer": 'Paid', location: "Boston", firstinterview: "no",   company_size: 400, "keyworddescription": "We make things look cool because people like cool stuff.If you shorten this decription, this box will get smaller. It's weird. So weird"},
      {name:'Allah',industry:'Corn Dogs', "paidvolunteer": 'Paid', location: "Boston", firstinterview: "no",  company_size: 40, "keyworddescription": "Our hotdogs are the largest and firmest hotdogs in all the land. We protect each hotdog with a cushy breading. So tasty nom nom nom" }
    	];
